        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">{developerProfile.name}</h3>
                <p className="text-gray-400">{developerProfile.title}</p>
              </div>
            </div>
            
            <p className="text-gray-300 mb-6 max-w-md">
              Desenvolvedor apaixonado por criar soluções digitais inovadoras que fazem a diferença. 
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} {developerProfile.name}. Todos os direitos reservados.
            </p>
